<div id="banker" class="row register-form" style="display: none;">
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" action='composent/database/bankerlogin.php' method='POST'>
                <h1>Bienvenu dans l'accès interne</h1>
